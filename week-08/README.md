...
![Hasil](./Docs/praktikum_1.png)
![Hasil](./Docs/praktikum_2.png)
...
class Item {
  ...
  Item({this.name, this.fotoUrl, this.price, this.stock, this.rating});
}
```
